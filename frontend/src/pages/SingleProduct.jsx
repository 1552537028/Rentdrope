...
function SingleProduct() {
  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <div className="lg:flex lg:flex-row mt-0 lg:mt-10 sm:flex sm:flex-col overflow-hidden">
        <div className="lg:flex lg:flex-row sm:flex sm:flex-col-reverse">
          <div className="lg:flex lg:flex-col gap-2 space-y-5 mr-7 mt-10 sm:flex sm:flex-row">
            {product.images.map((image, index) => (
              <img
                key={index}
                src={`https://rentdrope-1.onrender.com/uploads/${image}`}
                alt="Product"
        ...
        <div className="flex flex-col lg:ml-4 mt-7 w-full mr-5 overflow-hidden">
          ...
          <div className="lg:flex lg:flex-row gap-6 mt-6 sm:flex-col sm:gap-4">
  <button
    className="bg-yellow-400 text-white py-3 px-7 rounded-xl text-lg w-full lg:mb-0 mb-4 "
